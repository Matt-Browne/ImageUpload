	...
	public function __construct($upload){
		...
		if(empty($this->tmp_file)) { 
			...
			if($this->upload_err != 0) {
				...
				echo "<p><strong>ERROR: </strong>" . $upload_errors[$this->upload_err] . " please try again.</p>";
			} // end if (errors)
		} else {
			...
			echo "<p><strong>ERROR: </strong>Upload Denied, non approved file type!";
			} // end if
		}// end if (empty check)	
	} // end __construct
